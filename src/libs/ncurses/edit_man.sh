...
TERMINFO="/boot/common/data/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /Sources/haiku/src/libs/ncurses/man_alias.sed ; then
cat >>/Sources/haiku/src/libs/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Sources/haiku/src/libs/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /Sources/haiku/src/libs/ncurses/man_alias.sed | sort -u`
	...
	sed	-f /Sources/haiku/src/libs/ncurses/man_alias.sed \
		< $i >$TMP
